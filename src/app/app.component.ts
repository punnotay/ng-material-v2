...
export class AppComponent {
  ...
  constructor(iconReg: MdIconRegistry, sanitizer: DomSanitizer, private dialog: MdDialog) {
    const avatarUrl = sanitizer.bypassSecurityTrustResourceUrl('./assets/avatars.svg');
    iconReg.addSvgIconSetInNamespace('avatars', avatarUrl);
  }
